            ...
            <div class="col-12">
                <div class="admins d-flex justify-content-center align-items-center my-5 py-2">
                    ...
                    <div class="info-box px-5">
                        ...
                        <p><strong><i class="bi bi-person-walking me-2"></i>Contatta il mio messaggero:</strong> 3313131311</p>
                    </div>
                </div>
            </div>
            <div class="col-12">
                <div class="admins d-flex justify-content-center align-items-center my-5">
                    ...
                    <div class="info-box px-5">
                        ...
                        <p><strong><i class="bi bi-person-walking me-2"></i>Contatta il mio messaggero:</strong> 3803803830</p>
                    </div>
                </div>
                ...
                <div class="admins d-flex justify-content-center align-items-center my-5">
                    ...
                    <div class="info-box px-5">
                        ...
                        <p><strong><i class="bi bi-person-walking me-2"></i>Contatta il mio messaggero:</strong> 3253232252</p>
                    </div>
                </div>
            </div><div class="col-12">
                <div class="admins d-flex justify-content-center align-items-center my-5">
                    ...
                    <div class="info-box px-5">
                        ...
                        <p><strong><i class="bi bi-person-walking me-2"></i></i>Contatta il mio messaggero:</strong> 3333333333</p>
                    </div>
                </div>
            </div>
        </div>
